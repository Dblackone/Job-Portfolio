...
export default function AboutSection() {
  return (
    ...
    >
      ...
      <AnimatedText
        text="With more than five years of experience in architecture, BIM, and construction project management, i focus on delivering striking renders, precise documentation, and projects executed right the first time. i truly enjoy working with clients who want to see their vision built exactly as imagined. Let's build something incredible together!"
        className="max-w-[560px] text-center font-medium leading-relaxed text-[#4A4F5C]"
